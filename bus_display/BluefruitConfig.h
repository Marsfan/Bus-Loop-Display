...
#define FACTORYRESET_ENABLE         1  //if 1, resets bluefruit upon code upload, this means any glitches we made are cleared out. CHANGE TO 0 PRIOR TO DEPLOYING PROJECT
